...
assert(indexHtml.includes('href="changelog.html#pythos-1-5-0"'), 'Version link points to #pythos-1-5-0 anchor');
assert(changelogHtml.includes('id="pythos-1-5-0"'), 'Changelog has target anchor id="pythos-1-5-0"');
assert(changelogHtml.includes('class="back-btn"') && changelogHtml.includes('href="index.html"'), 'Changelog has back-link to workspace');
assert(indexHtml.includes('aria-label="Version 1.5.0 Release Notes"'), 'Version links have accessible screen reader names');
