...
assert(indexHtml.includes('href="changelog.html#pythos-1-8-7"'), 'Version link points to #pythos-1-8-7 anchor');
assert(changelogHtml.includes('id="pythos-1-8-7"'), 'Changelog has target anchor id="pythos-1-8-7"');
...
assert(indexHtml.includes('aria-label="Version 1.8.7 Release Notes"'), 'Version links have accessible screen reader names');
