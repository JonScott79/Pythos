...
assert(indexHtml.includes('href="changelog.html#pythos-1-8-10"'), 'Version link points to #pythos-1-8-10 anchor');
...
assert(indexHtml.includes('aria-label="Version 1.8.10 Release Notes"'), 'Version links have accessible screen reader names');
