...
assert(indexHtml.includes('href="changelog.html#pythos-1-8-9"'), 'Version link points to #pythos-1-8-9 anchor');
assert(changelogHtml.includes('id="pythos-1-8-9"'), 'Changelog has target anchor id="pythos-1-8-9"');
assert(changelogHtml.includes('id="pythos-1-8-8"'), 'Changelog retains previous release anchor id="pythos-1-8-8"');
assert(changelogHtml.includes('id="pythos-1-8-7"'), 'Changelog retains previous release anchor id="pythos-1-8-7"');
assert(changelogHtml.includes('id="pythos-1-8-6"'), 'Changelog retains previous release anchor id="pythos-1-8-6"');
assert(changelogHtml.includes('id="pythos-1-8-5"'), 'Changelog retains previous release anchor id="pythos-1-8-5"');
...
assert(changelogHtml.includes('id="pythos-1-7-3"'), 'Changelog retains previous release anchor id="pythos-1-7-3"');
assert(changelogHtml.includes('id="pythos-1-7-2"'), 'Changelog retains previous release anchor id="pythos-1-7-2"');
assert(changelogHtml.includes('id="pythos-1-7-1"'), 'Changelog retains previous release anchor id="pythos-1-7-1"');
assert(changelogHtml.includes('id="pythos-1-7-0"'), 'Changelog retains previous release anchor id="pythos-1-7-0"');
assert(changelogHtml.includes('id="pythos-1-6-3"'), 'Changelog retains previous release anchor id="pythos-1-6-3"');
assert(changelogHtml.includes('id="pythos-1-6-2"'), 'Changelog retains previous release anchor id="pythos-1-6-2"');
assert(changelogHtml.includes('id="pythos-1-6-1"'), 'Changelog retains previous release anchor id="pythos-1-6-1"');
...
assert(indexHtml.includes('aria-label="Version 1.8.9 Release Notes"'), 'Version links have accessible screen reader names');
